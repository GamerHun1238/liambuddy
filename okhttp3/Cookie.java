...
public final class Cookie
{
  ...
  Cookie(Builder builder) {
    if (name == null) throw new NullPointerException("builder.name == null");
    if (value == null) throw new NullPointerException("builder.value == null");
    if (domain == null) { throw new NullPointerException("builder.domain == null");
    }
    name = name;
    value = value;
    expiresAt = expiresAt;
  ...
  @Nullable
  public static Cookie parse(HttpUrl url, String setCookie) { return parse(System.currentTimeMillis(), url, setCookie); }
  ...
  public static List<Cookie> parseAll(HttpUrl url, Headers headers)
  {
    ...
    int i = 0; for (int size = cookieStrings.size(); i < size; i++) {
  ...
  public static final class Builder
  {
    ...
    public Builder expiresAt(long expiresAt) {
      ...
      if (expiresAt > 253402300799999L) expiresAt = 253402300799999L;
      this.expiresAt = expiresAt;
      persistent = true;
      return this;
    }
  ...
  public boolean equals(@Nullable Object other) {
    ...
    return (name.equals(name)) && 
      ...
      (path.equals(path)) && (expiresAt == expiresAt) && (secure == secure) && (httpOnly == httpOnly) && (persistent == persistent) && (hostOnly == hostOnly);
  }
