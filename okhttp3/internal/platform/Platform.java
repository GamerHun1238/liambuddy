...
public class Platform
{
  ...
  public static List<String> alpnProtocolNames(List<Protocol> protocols) {
    ...
    int i = 0; for (int size = protocols.size(); i < size; i++) {
  ...
  public static boolean isConscryptPreferred()
  {
    ...
    String preferredProvider = java.security.Security.getProviders()[0].getName();
  ...
  @Nullable
  static <T> T readFieldOrNull(Object instance, Class<T> fieldType, String fieldName) { for (Class<?> c = instance.getClass(); c != Object.class; c = c.getSuperclass()) {
      try {
