...
public abstract interface WebSocketListener
{
  ...
  public abstract void onTextMessage(WebSocket paramWebSocket, byte[] paramArrayOfByte)
    throws Exception;
  ...
  public abstract void onThreadCreated(WebSocket paramWebSocket, ThreadType paramThreadType, Thread paramThread)
    throws Exception;
  
  public abstract void onThreadStarted(WebSocket paramWebSocket, ThreadType paramThreadType, Thread paramThread)
    throws Exception;
  
  public abstract void onThreadStopping(WebSocket paramWebSocket, ThreadType paramThreadType, Thread paramThread)
    throws Exception;
