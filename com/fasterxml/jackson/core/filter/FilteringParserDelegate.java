  ...
  extends JsonParserDelegate
{
  ...
  public final int currentTokenId() { JsonToken t = _currToken;
    return t == null ? 0 : t.id();
  }
    ...
    throws IOException
  {
    ...
    case 3: 
      ...
      break;
    case 1:  TokenFilter f = _itemFilter;
      if (f == TokenFilter.INCLUDE_ALL) {
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      f = _headContext.checkValue(f);
    } while (((f != TokenFilter.INCLUDE_ALL) && ((f == null) || 
      (!f.includeValue(delegate)))) || 
      (!_verifyAllowedMatches()));
    return _nextBuffered(buffRoot);
  }
