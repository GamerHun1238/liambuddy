...
public class JsonPointer
{
  ...
  {
    int i = 0; for (int end = segment.length(); i < end; i++) {
  ...
  public String toString() { return _asString; }
  public int hashCode() { return _asString.hashCode(); }
  ...
  protected JsonPointer _constructHead()
  {
    ...
    return new JsonPointer(_asString.substring(0, _asString.length() - suffixLength), _matchingPropertyName, _matchingElementIndex, next
  ...
  protected JsonPointer _constructHead(int suffixLength, JsonPointer last)
  {
    ...
    return new JsonPointer(str.substring(0, str.length() - suffixLength), _matchingPropertyName, _matchingElementIndex, next
      ._constructHead(suffixLength, last));
  }
