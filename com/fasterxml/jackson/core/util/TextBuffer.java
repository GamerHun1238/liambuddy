...
public final class TextBuffer
{
  ...
  public void resetWith(char ch)
  {
    ...
    _currentSize = (this._segmentSize = 1);
  }
  ...
  public void resetWithCopy(char[] buf, int start, int len)
  {
    ...
    _currentSize = (this._segmentSize = 0);
  ...
  public char[] getTextBuffer()
  {
    ...
    if (_resultString != null) {
      return this._resultArray = _resultString.toCharArray();
    }
    ...
    if (_resultString == null)
    {
      if (_resultArray != null) {
        ...
        if (segLen == 0) {
          ...
          if (_segments != null) {
            int i = 0; for (int len = _segments.size(); i < len; i++) {
    ...
    throws IOException
  {
    ...
    int total = 0;
    if (_segments != null) {
      int i = 0; for (int end = _segments.size(); i < end; i++) {
        char[] curr = (char[])_segments.get(i);
