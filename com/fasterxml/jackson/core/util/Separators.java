  ...
  implements Serializable
{
  ...
  public Separators withObjectFieldValueSeparator(char sep) {
    return objectFieldValueSeparator == sep ? this : new Separators(sep, objectEntrySeparator, arrayValueSeparator);
  }
  ...
  {
    return arrayValueSeparator == sep ? this : new Separators(objectFieldValueSeparator, objectEntrySeparator, sep);
  }
