  ...
  implements Versioned
{
  ...
  public abstract <T> T readValue(JsonParser paramJsonParser, TypeReference<T> paramTypeReference)
    throws IOException;
  ...
  public abstract <T> Iterator<T> readValues(JsonParser paramJsonParser, TypeReference<T> paramTypeReference)
    throws IOException;
