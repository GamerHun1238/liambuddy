  ...
  extends BeanDeserializerBase
{
  ...
  {
    return new BeanAsArrayDeserializer(_delegate.withBeanProperties(props), _orderedProperties);
  }
    ...
    throws IOException
  {
    ...
    if ((!_ignoreAllUnknown) && (ctxt.isEnabled(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES))) {
      ctxt.reportWrongTokenException(this, JsonToken.END_ARRAY, "Unexpected JSON values; expected at most %d properties (in JSON Array)", new Object[] {
        ...
        if (creatorProp != null)
        {
          if (buffer.assignParameter(creatorProp, creatorProp.deserialize(p, ctxt))) {
            ...
            if (bean.getClass() != _beanType.getRawClass())
            {
              ...
              ctxt.reportBadDefinition(_beanType, String.format("Cannot support implicit polymorphic deserialization for POJOs-as-Arrays style: nominal type %s, actual type %s", new Object[] {_beanType
              

                .getRawClass().getName(), bean.getClass().getName() }));
            }
