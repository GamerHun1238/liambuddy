  ...
  public static NameTransformer simpleTransformer(String prefix, final String suffix)
  {
    ...
    if (hasPrefix) {
      if (hasSuffix) {
        new NameTransformer()
        {
          public String transform(String name) { return val$prefix + name + suffix; }
          ...
          public String toString() { return "[PreAndSuffixTransformer('" + val$prefix + "','" + suffix + "')]"; }
        };
      }
      new NameTransformer()
      {
        public String transform(String name) { return val$prefix + name; }
        ...
        public String toString() { return "[PrefixTransformer('" + val$prefix + "')]"; }
      };
    }
    if (hasSuffix) {
      new NameTransformer()
      {
        public String transform(String name) { return name + val$suffix; }
        ...
        public String toString() { return "[SuffixTransformer('" + val$suffix + "')]"; }
      };
    }
    return NOP;
  }
