  ...
  implements Version
{
    ...
    throws IOException
  {
    ...
    if (url.getProtocol().toLowerCase().equals("file")) {
      ...
      catch (IOException e)
      {
        ...
        try {
          is.close(); } catch (IOException localIOException3) {}
        if (fos != null) {
          try { fos.close();
          }
  ...
  public static int getNativeSize(Class<?> cls)
  {
    ...
    if ((Pointer.class.isAssignableFrom(cls)) || ((Platform.HAS_BUFFERS) && 
      (Buffers.isBuffer(cls))) || 
      (Callback.class.isAssignableFrom(cls)) || (String.class == cls) || (WString.class == cls))
    {
  ...
  private static Map<Class<?>, long[]> registeredClasses = new WeakHashMap();
  private static Map<Class<?>, NativeLibrary> registeredLibraries = new WeakHashMap();
  static final int CB_HAS_INITIALIZER = 1;
  
  private static void unregisterAll() { synchronized (registeredClasses) {
  ...
  public static void register(Class<?> cls, NativeLibrary lib)
  {
    ...
    for (int i = 0; i < handles.length; i++) {
      ...
      long rtype; long rtype; long closure_rtype; long rtype; long rtype; long closure_rtype; switch (rcvt) {
      case -1: 
      ...
      case 25: 
        ...
        long closure_rtype = getisPrimitivepeer;
      ...
      for (int t = 0; t < ptypes.length; t++) {
        ...
        case 24: 
        case 25: 
          closure_atypes[t] = getisPrimitivepeer;
          atypes[t] = getnativeTypepeer;
          break;
        case 0: 
          long tmp911_908 = getpeer;atypes[t] = tmp911_908;closure_atypes[t] = tmp911_908;
          break;
        case 1: case 2: case 3: case 5: case 6: case 7: case 8: case 9: case 10: case 11: case 12: case 13: case 14: case 15: case 16: case 20: default: 
          long tmp933_930 = getpeer;atypes[t] = tmp933_930;closure_atypes[t] = tmp933_930;
        }
      }
      sig = sig + ")";
      ...
      try {
        handles[i] = registerMethod(cls, method.getName(), sig, cvt, closure_atypes, atypes, rcvt, closure_rtype, rtype, method, peer, f
        



          .getCallingConvention(), throwLastError, toNative, fromNative, encoding);
  ...
  public static void main(String[] args)
  {
    ...
    if (version == null) version = "4.4.0 (package information missing)";
  ...
  {
    invokeStructure(function, fp, callFlags, args, getPointerpeer, 
      getTypeInfopeer);
    return s;
  }
  ...
  static String getString(Pointer pointer, long offset, String encoding) {
    byte[] data = getStringBytes(pointer, peer, offset);
    if (encoding != null) {
      try {
  ...
  private static final ThreadLocal<Memory> nativeThreadTerminationFlag = new ThreadLocal()
  {
  ...
  static Pointer getTerminationFlag(Thread t) { return (Pointer)nativeThreads.get(t); }
