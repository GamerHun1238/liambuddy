  ...
  implements Serializable, Cloneable
{
  ...
  public V get(Object key1, Object key2)
  {
    ...
    AbstractHashedMap.HashEntry<MultiKey<? extends K>, V> entry = decorateddata[decorated().hashIndex(hashCode, decorateddata.length)];
    
    while (entry != null) {
      if ((hashCode == hashCode) && (isEqualKey(entry, key1, key2))) {
  ...
  {
    int hashCode = hash(key1, key2);
    int index = decorated().hashIndex(hashCode, decorateddata.length);
    AbstractHashedMap.HashEntry<MultiKey<? extends K>, V> entry = decorateddata[index];
    while (entry != null) {
      if ((hashCode == hashCode) && (isEqualKey(entry, key1, key2))) {
  ...
  public V get(Object key1, Object key2, Object key3)
  {
    ...
    while (entry != null) {
      if ((hashCode == hashCode) && (isEqualKey(entry, key1, key2, key3))) {
        return entry.getValue();
      }
      entry = next;
    }
  ...
  public V get(Object key1, Object key2, Object key3, Object key4)
  {
    ...
    while (entry != null) {
      if ((hashCode == hashCode) && (isEqualKey(entry, key1, key2, key3, key4))) {
        return entry.getValue();
      }
      entry = next;
    }
  ...
  public V get(Object key1, Object key2, Object key3, Object key4, Object key5)
  {
    ...
    while (entry != null) {
      if ((hashCode == hashCode) && (isEqualKey(entry, key1, key2, key3, key4, key5))) {
        return entry.getValue();
      }
      entry = next;
    }
