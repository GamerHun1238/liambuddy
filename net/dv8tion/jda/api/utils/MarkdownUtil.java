...
public final class MarkdownUtil
{
  ...
  {
    String sanitized = MarkdownSanitizer.escape(input, 65407);
  ...
  {
    String sanitized = MarkdownSanitizer.escape(input, 65279);
    return "~~" + sanitized + "~~";
  }
  ...
  {
    String sanitized = MarkdownSanitizer.escape(input, 65023);
